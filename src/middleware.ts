...
const PUBLIC_PATHS = ['/login', '/auth', '/api/auth', '/api/messages/twilio-webhook', '/view', '/cni/onboard', '/credit-application', '/api/credit-application', '/portal', '/api/portal', '/book', '/api/book'];
