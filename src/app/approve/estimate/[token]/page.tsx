...
export default function EstimateApprovalPage() {
  return (
    <ApprovalPageShell
      ...
      renderDocument={d => <EstimateDocument estimate={d.estimate} lines={d.lines} graphics={d.graphics} />}
    />
  );
}

function EstimateDocument({ estimate: est, lines, graphics }: { estimate: any; lines: any[]; graphics: any[] }) {
