  ...
  if (loading) {
    return (
      <div style={{ textAlign: 'center', padding: '40px 0' }}>
        ...
        <div style={{ color: '#4a5f78', marginTop: '12px', fontSize: '13px', fontWeight: 600 }}>Loading estimates...</div>
      </div>
    );
  }
  ...
  return (
    <div>
              ...
              <div style={{
                ...
                {custResults.map(c => (
                  ...
                  >
                    ...
                    <div style={{ fontSize: '10px', color: '#4a5f78' }}>{c.entity_id} · NS #{c.netsuite_id}</div>
                  </button>
                ))}
              </div>
            )}
      ...
      <div style={{ marginBottom: '8px' }}>
                  ...
                  >
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                      <div>
                        ...
                        <span style={{ color: '#4a5f78', marginLeft: '8px' }}>{p.display_name || p.description}</span>
                      </div>
                      <div style={{ display: 'flex', gap: '10px', flexShrink: 0 }}>
                        ...
                        <span style={{ color: '#4a5f78', fontSize: '10px', textTransform: 'uppercase' }}>{p.catalog}</span>
                      </div>
                    </div>
                  </button>
                ))}
        ...
        {/* Line item rows */}
        {lines.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '20px', color: '#4a5f78', fontSize: '12px', border: '1px dashed #1e2d3d', borderRadius: '8px' }}>
            Search for parts above or add a custom line item
          </div>
        ) : (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            {/* Header row */}
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr 60px 80px 80px 60px 30px', gap: '4px', padding: '4px 0', fontSize: '9px', fontWeight: 700, color: '#4a5f78', textTransform: 'uppercase' }}>
              <div>Item #</div>
              <div>Description</div>
            ...
            {lines.map(line => (
              ...
              >
                ...
                {line.is_custom && !isPushed ? (
                  ...
                  <div style={{ fontSize: '11px', color: '#6b7a8d', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{line.description}</div>
                )}
                ...
                <div style={{ fontSize: '10px', color: line.labor_hours > 0 ? '#fbbf24' : '#4a5f78', textAlign: 'center' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '8px', marginBottom: '10px' }}>
          ...
          <div>
            ...
            <div style={{ padding: '8px 10px', borderRadius: '8px', border: '1px solid #2a3a4d', background: '#0a0f14', color: '#fbbf24', fontSize: '12px', fontWeight: 700 }}>
              ...
              <span style={{ color: '#4a5f78', fontWeight: 400, fontSize: '10px', marginLeft: '4px' }}>(from parts)</span>
            </div>
          </div>
          <div>
