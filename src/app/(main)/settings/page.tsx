...
export default function SettingsPage() {
  ...
  if (loading || !prefs) {
    return (
      <div style={{ textAlign: 'center', padding: '40px 0', color: '#d0dcea', fontSize: '13px' }}>
        Loading settings...
      </div>
    );
  }
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '10px', color: '#d0dcea' }}>Get notified when a new graphics job is created or flagged from a PO</div>
            </div>
          </label>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '10px', color: '#d0dcea' }}>Get notified when any job status changes</div>
            </div>
          </label>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '10px', color: '#d0dcea' }}>Get notified when a job is marked ready to install</div>
            </div>
          </label>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '10px', color: '#d0dcea' }}>Get notified when a job is shipped with tracking info</div>
            </div>
          </label>
        </div>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    color: isSelected ? GRAPHICS_STATUS_COLORS[s] : '#d0dcea',
                    cursor: 'pointer',
                  }}
                >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '10px', color: '#d0dcea' }}>Show alerts in the notification bell</div>
            </div>
          </label>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '10px', color: '#d0dcea' }}>Send alerts to {profile?.email || 'your email'}</div>
            </div>
          </label>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '10px', color: '#d0dcea' }}>Send text alerts to your phone</div>
            </div>
          </label>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '10px', color: '#d0dcea' }}>Receive chat messages as texts. Reply via SMS and it appears in the app.</div>
            </div>
          </label>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              <div style={{ fontSize: '12px', fontWeight: 700, color: '#f5f8fc' }}>Email Notifications</div>
              <div style={{ fontSize: '10px', color: '#d0dcea' }}>Get an email when someone sends you a chat message.</div>
            </div>
          </label>
          ...
          {prefs.sms_messages && (
            <div style={{ marginLeft: '30px' }}>
              ...
              <div style={{ display: 'flex', gap: '6px', marginTop: '4px' }}>
                <button
                  ...
                  style={{
                    ...
                    color: prefs.sms_messages_mode === 'always' ? '#60a5fa' : '#d0dcea',
                    cursor: 'pointer',
                  }}
                >
                  Every message
                ...
                <button
                  ...
                  style={{
                    ...
                    color: prefs.sms_messages_mode === 'unread_only' ? '#60a5fa' : '#d0dcea',
                    cursor: 'pointer',
                  }}
                >
                  Only if unread
              ...
              <div style={{ fontSize: '10px', color: '#d0dcea', marginTop: '4px' }}>
          ...
          {prefs.sms_messages && !prefs.phone_number && (
            <div style={{ marginLeft: '30px', padding: '8px 10px', borderRadius: '8px', background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.2)' }}>
              ...
              <div style={{ fontSize: '10px', color: '#d0dcea', marginTop: '2px' }}>Enter your phone number in the Delivery Methods section above to enable SMS.</div>
            </div>
          )}
        </div>
      </div>
