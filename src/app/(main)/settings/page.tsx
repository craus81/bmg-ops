  ...
  return (
    <div>
      ...
      <div style={sectionStyle}>
        <div style={{ fontSize: '14px', fontWeight: 800, color: '#e8ecf1', marginBottom: '10px' }}>Graphics Job Alerts</div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              <div style={{ fontSize: '12px', fontWeight: 700, color: '#e8ecf1' }}>New Job Created</div>
              <div style={{ fontSize: '10px', color: '#a8bfd4' }}>Get notified when a new graphics job is created or flagged from a PO</div>
            </div>
          </label>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              <div style={{ fontSize: '12px', fontWeight: 700, color: '#e8ecf1' }}>Status Changes</div>
              <div style={{ fontSize: '10px', color: '#a8bfd4' }}>Get notified when any job status changes</div>
            </div>
          </label>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              <div style={{ fontSize: '12px', fontWeight: 700, color: '#e8ecf1' }}>Ready to Install</div>
              <div style={{ fontSize: '10px', color: '#a8bfd4' }}>Get notified when a job is marked ready to install</div>
            </div>
          </label>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              <div style={{ fontSize: '12px', fontWeight: 700, color: '#e8ecf1' }}>Shipped</div>
              <div style={{ fontSize: '10px', color: '#a8bfd4' }}>Get notified when a job is shipped with tracking info</div>
            </div>
          </label>
        </div>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    color: isSelected ? GRAPHICS_STATUS_COLORS[s] : '#a8bfd4',
                    cursor: 'pointer',
                  }}
                >
      ...
      {/* Delivery Methods */}
      <div style={sectionStyle}>
        <div style={{ fontSize: '14px', fontWeight: 800, color: '#e8ecf1', marginBottom: '10px' }}>Delivery Methods</div>

        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            <input type="checkbox" checked={prefs.notify_in_app} onChange={e => setPrefs({ ...prefs, notify_in_app: e.target.checked })} />
            <div>
              <div style={{ fontSize: '12px', fontWeight: 700, color: '#e8ecf1' }}>In-App Notifications</div>
              <div style={{ fontSize: '10px', color: '#a8bfd4' }}>Show alerts in the notification bell</div>
            </div>
          </label>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              <div style={{ fontSize: '12px', fontWeight: 700, color: '#e8ecf1' }}>Email Notifications</div>
              <div style={{ fontSize: '10px', color: '#a8bfd4' }}>Send alerts to {profile?.email || 'your email'}</div>
            </div>
          </label>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              <div style={{ fontSize: '12px', fontWeight: 700, color: '#e8ecf1' }}>Text Message (SMS)</div>
              <div style={{ fontSize: '10px', color: '#a8bfd4' }}>Send text alerts to your phone</div>
            </div>
          </label>
      ...
      <div style={sectionStyle}>
        <div style={{ fontSize: '14px', fontWeight: 800, color: '#e8ecf1', marginBottom: '4px' }}>Chat Message Delivery</div>
        <div style={{ fontSize: '11px', color: '#a8bfd4', marginBottom: '10px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              <div style={{ fontSize: '12px', fontWeight: 700, color: '#e8ecf1' }}>SMS Text Messages</div>
              <div style={{ fontSize: '10px', color: '#a8bfd4' }}>Receive chat messages as texts. Reply via SMS and it appears in the app.</div>
            </div>
          </label>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
            ...
            <div>
              <div style={{ fontSize: '12px', fontWeight: 700, color: '#e8ecf1' }}>Email Notifications</div>
              <div style={{ fontSize: '10px', color: '#a8bfd4' }}>Get an email when someone sends you a chat message.</div>
            </div>
          </label>
          ...
          {prefs.sms_messages && (
            <div style={{ marginLeft: '30px' }}>
              ...
              <div style={{ display: 'flex', gap: '6px', marginTop: '4px' }}>
                <button
                  ...
                  style={{
                    ...
                    color: prefs.sms_messages_mode === 'always' ? '#60a5fa' : '#a8bfd4',
                    cursor: 'pointer',
                  }}
                >
                  Every message
                ...
                <button
                  ...
                  style={{
                    ...
                    color: prefs.sms_messages_mode === 'unread_only' ? '#60a5fa' : '#a8bfd4',
                    cursor: 'pointer',
                  }}
                >
                  Only if unread
              ...
              <div style={{ fontSize: '10px', color: '#a8bfd4', marginTop: '4px' }}>
          ...
          {prefs.sms_messages && !prefs.phone_number && (
            <div style={{ marginLeft: '30px', padding: '8px 10px', borderRadius: '8px', background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.2)' }}>
              ...
              <div style={{ fontSize: '10px', color: '#a8bfd4', marginTop: '2px' }}>Enter your phone number in the Delivery Methods section above to enable SMS.</div>
            </div>
          )}
        </div>
      </div>
      ...
      <button
        ...
        style={{
          ...
          color: '#b4c8db', fontSize: '13px', fontWeight: 700, cursor: 'pointer',
        }}
      >
        ← Back
      </button>
