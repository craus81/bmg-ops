                    ...
                    <div key={est.id}>
                      <button
                        ...
                        {invWorking === est.id || invWorking === est.netsuite_so_id ? 'Working…'
                          : est.netsuite_so_id ? `Fulfill & Invoice SO ${est.netsuite_so_number || `#${est.netsuite_so_id}`} (${estimateHeadlineNumber(est)})`
                          : `Convert ${estimateHeadlineNumber(est)} to SO, Fulfill & Invoice`}
                      </button>
                      {overrideFor === est.id && (
