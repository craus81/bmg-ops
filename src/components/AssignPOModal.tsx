        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
            ...
            <button onClick={onClose} style={{
              ...
              padding: '4px 10px', color: '#6b7a8d', fontSize: '11px', fontWeight: 700, cursor: 'pointer',
            }}>ESC</button>
          </div>
        ...
        <div style={{ flex: 1, overflowY: 'auto' }}>
          ...
          {!searching && pos.length === 0 && (
            <div style={{ padding: '40px 20px', textAlign: 'center' }}>
              ...
              <div style={{ fontSize: '14px', fontWeight: 700, color: '#4a5f78' }}>No POs found</div>
                    ...
                    {po.po_line_items && po.po_line_items.length > 0 && (
                      <div style={{ marginTop: '6px' }}>
                        {po.po_line_items.slice(0, 3).map((li) => (
                          <div key={li.id} style={{
                            fontSize: '10px', color: '#4a5f78', marginTop: '2px',
                            display: 'flex', gap: '6px', alignItems: 'center',
                          }}>
                            <span style={{
                              color: li.part_number?.toLowerCase() === vehiclePartNumber?.toLowerCase() ? '#4ade80' : '#6b7a8d',
