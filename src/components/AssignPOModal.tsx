      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
            <div>
              <div style={{ fontSize: '15px', fontWeight: 800, color: '#e8ecf1' }}>Assign Purchase Order</div>
              <div style={{ fontSize: '11px', color: '#b4c8db', marginTop: '2px' }}>
            ...
            <button onClick={onClose} style={{
              ...
              padding: '4px 10px', color: '#b4c8db', fontSize: '11px', fontWeight: 700, cursor: 'pointer',
            }}>ESC</button>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <input
              ...
              style={{
                ...
                color: '#e8ecf1', fontSize: '14px', fontWeight: 600,
              }}
            />
          </div>
        </div>
        ...
        <div style={{ flex: 1, overflowY: 'auto' }}>
          ...
          {!searching && pos.length === 0 && (
            <div style={{ padding: '40px 20px', textAlign: 'center' }}>
              ...
              <div style={{ fontSize: '14px', fontWeight: 700, color: '#a8bfd4' }}>No POs found</div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '6px' }}>
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <span style={{ fontSize: '13px', fontWeight: 700, color: '#e8ecf1' }}>PO #{po.po_number}</span>
                      <span style={{
                    ...
                    {po.po_line_items && po.po_line_items.length > 0 && (
                      <div style={{ marginTop: '6px' }}>
                        {po.po_line_items.slice(0, 3).map((li) => (
                          <div key={li.id} style={{
                            fontSize: '10px', color: '#a8bfd4', marginTop: '2px',
                            display: 'flex', gap: '6px', alignItems: 'center',
                          }}>
                            <span style={{
                              color: li.part_number?.toLowerCase() === vehiclePartNumber?.toLowerCase() ? '#4ade80' : '#b4c8db',
