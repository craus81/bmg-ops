...
5. Tap **Create Prospect**.

To add a contact (name, email, phone) on that prospect:

1. Tap **+ Add** under **Contacts** on the prospect's row.
2. Type the contact's info.
3. Tap **Save**.
...
The customer gets a link. They click it, see the estimate on a public
page, and tap **Accept & Authorize Work** or **Request Changes**. No
login needed.
