...
13. **Unchanged decisions and builds:** R3-21 labor capture and R3-22
    ...
    new PO portal presigns) *(R3-21 decided and shipped 2026-09-07 —
    #831 + migration 269, job costing only; see §7.5. R3-22 alone
    remains)*. The requireAdmin-excludes-super_admin
...
Still open after this pass, deliberately with the owner: one standing
decision (R3-22 R2-goes-private).
