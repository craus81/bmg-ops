...
Still open after this pass, all deliberately with the owner: R3-16a's
notes half and the two standing decisions (R3-21 labor capture, R3-22
R2-goes-private).
