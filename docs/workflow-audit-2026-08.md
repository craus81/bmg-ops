...
Still open after this pass, all deliberately with the owner: the
multi-PO join table, R3-16a's notes half, and the standing decisions
(R3-21 labor capture, R3-22 R2-goes-private, requireAdmin vs
super_admin).
